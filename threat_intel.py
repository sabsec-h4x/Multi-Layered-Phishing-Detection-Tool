"""
PhishGuard Threat Intelligence Integration Bridge
-------------------------------------------------
Maintains backward compatibility for legacy imports while routing through
the modular ThreatIntelProvider architecture and TTL caching layer.
"""
